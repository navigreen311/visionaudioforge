...
![Endpoints](https://img.shields.io/badge/endpoints-598-orange)
...
| **Source Files** | 681 | `.py` / `.ts` / `.tsx` under `backend/app`, `frontend/src`, `sdk` |
| **API Endpoints** | 598 | method + path operations on the mounted router, across 533 distinct `/api` paths |
