...
class TestInstaller:
    ...
    These once targeted a `VerticalInstaller` class with async
    (db, workspace_id, slug) methods. No such class exists — the installer is a
    module of synchronous functions over a registry — and the stale import
    aborted collection for the entire suite. Written against the real API.
    """
